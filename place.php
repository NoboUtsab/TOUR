...
<head>
    ...
    <style>
        body{
            background: url("Background/place.jpg")no-repeat;
                        ...
                        <div class="registration-container" style="width: 50%;margin: 0 auto">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <label><b>Please select the place </b></label>
                                    <div class="autocomplete" style="width:300px;">
                                        <input id="myInput" type="text" name="myCountry" id="myCountry" placeholder="Enter the place" required>
                                    </div>
